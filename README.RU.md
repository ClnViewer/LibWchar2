...
Определенно удобно может быть переопределение стандартных функций работающих с файловой системой, таких как: `mkdir`, `remove`, `rename`, `stat`, `basename`, `fopen`, `fputc`, `fputs`.
