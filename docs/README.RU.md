...
- Проверяя свой код программами анализа вы делаете его надежнее, если вы используете [cppcheck](https://ru.wikipedia.org/wiki/Cppcheck) возможно вам будет полезен [XML файл](https://github.com/ClnViewer/LibWchar2/blob/master/docs/libchar2.cfg) описывающий функции библиотеки, для более точного анализа Вашего кода. Пример [проекта](https://github.com/ClnViewer/LibWchar2/blob/master/docs/libchar2.cppcheck) для использования с этой библиотекой.    
