...
- Проверяя свой код программами анализа вы делаете его надежнее, если вы используете [cppcheck](https://ru.wikipedia.org/wiki/Cppcheck) возможно вам будет полезны [файлы конфигурации](https://clnviewer.github.io/LibWchar2/docs/README-CPPCHECK.RU.md) с описанием функций библиотеки для анализатора `cppcheck`.
